...
def run_report(config_path: str | Path | None = None) -> int:
    ...
    print("[2/7] Fetching inflation data...")
    ...
    print("[4/7] Fetching ECB interest rates...")
    interest_df = fetch_ecb_interest_rates()
    print(f"      Fetched {len(interest_df)} interest rate data points")
    print()

    print(f"[5/7] Generating {config.forecast_months}-month inflation forecast...")
